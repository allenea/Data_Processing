...
This program combines all NJ Mesonet stations then trims data that is not needed for 
...
# This file will take a little while to run when it is processing 5 years of 5 minute data
# from many stations
"""
import numpy as np
import pandas as pd
...
outstring = os.path.abspath('../..')+"/Verify_Converted/All_Sources/NJMET-verify-converted.csv"

allfiles =  glob.glob("*.csv")   
print ("NJ Mesonet File Count:", len(allfiles))
...
sortdf = sortdf.mask(sortdf=="NaN", -888888.0)
